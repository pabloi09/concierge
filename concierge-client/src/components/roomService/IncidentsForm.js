...
import { incidents, getJson } from "../../constants/incidents";
            ...
            <form onSubmit={handleSubmit}>
                <Card className={classes.card}>
                    ...
                    <Typography className={classes.title} color="textPrimary" gutterBottom>
                        ¿Con qué ha tenido una incidencia?
                    </Typography>
                        <TextField
                            id="element"
                            name="element"
    ...
    validationSchema: Yup.object().shape({
        element: Yup.string()
            ...
            .test("isDefault", "Inyección de código detectada", 
                function(value) {
                    if(value !== ""){
                        return incidents.reduce((acumulator = false, element)=> acumulator = acumulator || (element["value"] === value))
                    }
                    return false
                })
...
class IncidentsForm extends React.Component{
    constructor(props){
      super(props)
